...
```sh
go get github.com/charlievieth/tools/gopls@latest
```
...
```sh
go get github.com/charlievieth/tools/gopls@vX.Y.Z
```
...
```sh
GO111MODULE=on go get github.com/charlievieth/tools/gopls@latest
```
...
```sh
go get github.com/charlievieth/tools/gopls@master golang.org/x/tools@master
```
