...
import (
	...
	"github.com/charlievieth/tools/xint/lsp/baz"
	_ "github.com/charlievieth/tools/xint/lsp/signature" // provide type information for unimported completions in the other file
)
