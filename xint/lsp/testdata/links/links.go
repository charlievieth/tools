...
import (
	...
	"github.com/charlievieth/tools/xint/lsp/foo" //@link(`github.com/charlievieth/tools/xint/lsp/foo`,`https://pkg.go.dev/github.com/charlievieth/tools/xint/lsp/foo`)
